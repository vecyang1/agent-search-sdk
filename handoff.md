...
| Field | Value |
| --- | --- |
| Subject | Agent Search SDK v1.1.1 — web-search-manager retired; v1.1.0 debug pass, settings layer, honest tests, MCP launcher |
| Last Updated | 2026-09-04 18:55 Asia/Bangkok |
| Updated By | Claude (Claude Code) |
| Requested By | Vec |
| Next Actor | Any autonomous agent |
| Next Required Action | None required. Optional: register MCP globally (`~/.gemini/antigravity/skills/agent-search-sdk/references/mcp.md`). |
